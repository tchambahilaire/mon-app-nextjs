  ...
  return (
    <div className="min-h-screen bg-[#0b0d1a] text-[#d0d6f0] font-['Courier_New',monospace] flex flex-col">
      <style>{`
        ...
        .nav-links a:hover { color: #00f0ff; background: #1a1f38; border-color: #00f0ff44; }
        .nav-links a.active { color: #00f0ff; background: #1a1f38; border-color: #00f0ff; box-shadow: 0 0 20px #00f0ff15; }
        .btn-neon {
          background: transparent;
        ...
        .stat-card:hover { border-color: #00f0ff; box-shadow: 0 0 30px #00f0ff15; transform: translateY(-2px); }
        .stat-value { font-size: 32px; font-weight: 700; color: #00f0ff; text-shadow: 0 0 30px #00f0ff33; }
        .resource-card {
          background: #10152b;
          border: 1px solid #1f2a50;
          border-radius: 16px;
        ...
        .resource-card:hover { border-color: #b47aff; box-shadow: 0 0 30px #b47aff15; transform: translateY(-4px); }
        .empty-state {
          background: #10152b;
          ...
          <div className="flex gap-2 flex-wrap">
            <button
              ...
              className={`px-4 py-2 rounded-xl border transition ${
                filter === "all" ? "border-[#00f0ff] text-[#00f0ff] bg-[#00f0ff]/10" : "border-[#1f2a50] text-[#6a7aaa] hover:border-[#00f0ff]"
              }`}
            >
              Tous
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-xl border transition ${
                filter === "published" ? "border-emerald-400 text-emerald-400 bg-emerald-400/10" : "border-[#1f2a50] text-[#6a7aaa] hover:border-emerald-400"
              }`}
            >
              📢 Publiés
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-xl border transition ${
                filter === "draft" ? "border-amber-400 text-amber-400 bg-amber-400/10" : "border-[#1f2a50] text-[#6a7aaa] hover:border-amber-400"
              }`}
            >
              ✏️ Brouillons
            </button>
                ...
                {paginatedResources.map((resource) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <span className={`text-xs px-3 py-1 rounded-full font-bold ${resource.published ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' : 'bg-amber-500/20 text-amber-400 border border-amber-500/30'}`}>
